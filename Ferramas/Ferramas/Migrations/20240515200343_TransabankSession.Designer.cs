...
namespace Ferramas.Migrations
{
    ...
    [Migration("20240515200343_TransabankSession")]
    partial class TransabankSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ferramas.Model.Domain.FerraUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9875d2bc-19c0-49f3-a7fb-08219555f574"),
                        ...
                        new
                        {
                            Id = new Guid("ff4f2df3-7a06-4e8c-a513-819733905b03"),
                        ...
                        new
                        {
                            Id = new Guid("9663b650-16ca-4119-a371-e28c57df3ed5"),
            ...
            modelBuilder.Entity("Ferramas.Model.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("45cf756c-bb0e-40ac-b2e5-2b3b06c6b503"),
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("09de98f4-03ba-4f16-be9f-6cf231d666ec"),
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("1166f530-4917-4a5e-a832-b643a81539b4"),
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("5f3533c9-b1a9-4501-bdac-70b7095ee267"),
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("2395eda7-3a35-4721-81e2-43ebbd48c0c1"),
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("a1526dc2-ad6c-4d6f-930b-378d9372f69f"),
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("55c58833-27e1-453f-aae2-5e419bf7e691"),
                            CategoryId = 6,
